...
public class ReacherOutToPosition extends CommandBase {
  private final Reacher m_reacher;
  private double m_goal;
  private double m_currentPosition;

  /**
   * Creates a new ReacherOutToPosition.
   *
   * @param subsystem The subsystem used by this command.
   */
  public ReacherOutToPosition(Reacher subsystem, double timePositionSeconds) {
    m_reacher = subsystem;
